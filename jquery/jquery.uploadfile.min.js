...
(function(b){
    ...
    this.stopUpload=function(){
        b(".ajax-file-upload-red").each(function(u,s){
    ...
    function q(y,B,D,u){
        ...
        if(D.nestedForms){
            ...
            z.css({
                    position:"absolute",cursor:"pointer",top:"0px",width:C,height:x,left:"0px","z-index":"100",opacity:"0.0",filter:"alpha(opacity=0)","-ms-filter":"alpha(opacity=0)","-khtml-opacity":"0.0","-moz-opacity":"0.0"
                }
            );
            w.appendTo(u)
        }
    ...
    function p(v,u){
        ...
        this.abort=b("<div class='ajax-file-upload-red "+v.formGroup+"'>"+u.abortStr+"</div>").appendTo(this.statusbar).hide();
        this.cancel=b("<div class='ajax-file-upload-red'>"+u.cancelStr+"</div>").appendTo(this.statusbar).hide();
